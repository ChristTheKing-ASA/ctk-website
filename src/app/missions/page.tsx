  ...
  return (
    <>
      <PageHeader
        ...
        description="Through faithful giving, CTK supports 11 mission partners monthly—locally, nationally, and around the world."
      ...
      <Section background="white">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-cream-50 p-6 rounded-xl text-center">
            <p className="text-4xl font-bold text-navy-900 mb-2">11</p>
            <p className="text-navy-600">Monthly Partners</p>
          </div>
          <div className="bg-cream-50 p-6 rounded-xl text-center">
            <p className="text-4xl font-bold text-navy-900 mb-2">4</p>
            <p className="text-navy-600">Local</p>
          </div>
          <div className="bg-cream-50 p-6 rounded-xl text-center">
            <p className="text-4xl font-bold text-navy-900 mb-2">2</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPartners.map((partner) => (
            <PartnerCard
              key={partner.slug}
              name={partner.name}
              subtitle={"subtitle" in partner ? String(partner.subtitle) : undefined}
      ...
      <Section background="cream">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {missionPartners.additional.map((partner) => (
            <div
              key={partner.name}
